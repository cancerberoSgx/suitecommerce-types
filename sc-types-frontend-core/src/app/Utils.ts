...
export interface IUtils {
   ...
   */
  getPathFromObject<T = any>(object: {[k: string]: any}, path: string, default_value: any): T
  /**
   ...
   */
  setPathFromObject(object: {[k: string]: any}, path: string, value: any) : void
